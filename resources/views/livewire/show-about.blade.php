		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-7">
				<div class="section-title">
					<p class="text-primary text-uppercase fw-bold mb-3">A propos</p>
					<h2 class="h1 mb-4">MLDIOUF Dev web</h2>
                        ...
                        <div class="card-img">
                            ...
                            @if($member->fb_url != '' || $member->tw_url != "" || $member->in_url != "")
                                <ul class="card-social list-inline">
                                    ...
                                    @endif
                                    @if($member->tw_url != '')
                                        <li class="list-inline-item"><a target="_blank" class="twitter" href="{{$member->tw_url}}"><i class="fab fa-twitter"></i></a>
                                        </li>
                                    @endif
                                    @if($member->in_url != '')
                                        <li class="list-inline-item"><a target="_blank" class="instagram" href="{{$member->in_url}}"><i class="fab fa-instagram"></i></a>
                                        </li>
                                    @endif
                                </ul>
                            @endif
